...
import { ModalRef } from "../common/modalRef/modalRef";
...
export const MainPage = () => {
  ...
  console.log('appr', approwed)
  return (
    <div className={!scrolle ? styles.wrapper : styles.positionFix}>

      {/* {activeRef && <ModalRef modalActiveRef={setActiveRef} modalActiveConfirm={setActiveConfirm} />} */}
      {activeConfirm && <ModalConfirm modalActiveConfirm={setActiveConfirm}/>}

      {!approwed &&
      <div className={styles.specialCardsWrapper}>
        <SpecialCards cards={getSpecialCards()} isMobile={isMobile} modalActiveRef={setActiveRef} modalActive={setActive}/>
      </div>
      }
      {approwed &&
      <div className={styles.specialCardsWrapper}>
        <SpecialCards cards={getSpecialCards()} isMobile={isMobile} modalActiveRef={setActiveRef}/>
      </div>
      }
